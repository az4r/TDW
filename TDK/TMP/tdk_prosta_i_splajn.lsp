(defun c:tdk_prosta_i_splajn()
  ...
  (if (equal tdk_prosta_i_splajn_kierunek_rozstawu "S")
    (progn
      (setq tdk_prosta_i_splajn_operator +)
      (setq tdk_prosta_i_splajn_polowa_obszaru_rozstawu (/ tdk_prosta_i_splajn_dlugosc_obszaru 2))
      (setq tdk_prosta_i_splajn_srodek_rozstawu (list (/ (+ (car tdk_prosta_i_splajn_poczatek_rozstawu) (car tdk_prosta_i_splajn_koniec_rozstawu)) 2) (/ (+ (cadr tdk_prosta_i_splajn_poczatek_rozstawu) (cadr tdk_prosta_i_splajn_koniec_rozstawu)) 2) (caddr tdk_prosta_i_splajn_poczatek_rozstawu)))
      ;(setq tdk_prosta_i_splajn_poczatek_rozstawu (mapcar '- tdk_prosta_i_splajn_srodek_rozstawu '(tdk_prosta_i_splajn_polowa_obszaru_rozstawu 0 0)))
      (setq tdk_prosta_i_splajn_poczatek_rozstawu (subst (- (car tdk_prosta_i_splajn_srodek_rozstawu) tdk_prosta_i_splajn_polowa_obszaru_rozstawu) (car tdk_prosta_i_splajn_srodek_rozstawu) tdk_prosta_i_splajn_srodek_rozstawu))
    )
    (princ)
  )
  ...
  (setq tdk_prosta_i_splajn_tabela (vla-Addtable tdk_prosta_i_splajn_przestrzen_modelu (vlax-3d-point tdk_prosta_i_splajn_punkt_wstawienia_tabeli) (1+ tdk_prosta_i_splajn_liczba_rozstawow) 2 10 70))
  ...
  ;(vla-setcelltextheight tdk_prosta_i_splajn_tabela 0 0 0.25)
  (setq tdk_prosta_i_splajn_tabela_wiersz 1)
  (repeat tdk_prosta_i_splajn_liczba_rozstawow
    ...
    (vla-settext tdk_prosta_i_splajn_tabela tdk_prosta_i_splajn_tabela_wiersz 0 tdk_prosta_i_splajn_tabela_wiersz)
    (vla-settext tdk_prosta_i_splajn_tabela tdk_prosta_i_splajn_tabela_wiersz 1 tdk_prosta_i_splajn_odleglosc)
    (setq tdk_prosta_i_splajn_tabela_wiersz (1+ tdk_prosta_i_splajn_tabela_wiersz))
  )
  (command "_UCS" "_P")
  (setq tdk_prosta_i_splajn_ob1 nil)
  (setq tdk_prosta_i_splajn_ob2 nil)
